...
- **Что вы изучили по каждому самостоятельному блоку в процессе выполнения:**
  - В задании 1 (первый ноутбук) я исследовала устойчивость shortlist к изменению `variance_threshold` и `top_n`.
  - В задании 2 (первый ноутбук) я рассчитала попарные метрики сходства (overlap и Jaccard) между конфигурациями.
  - В задании 3 (первый ноутбук) я сохранила результаты и проанализировала сводку по устойчивости.
...
## 10. Ссылки на отчёты по частям

- [ЛР 01.1 — Filter Methods для оценки значимости признаков](./report-01-1.md)
- [ЛР 01.2 — Wrapper + Embedded методы отбора признаков](./report-01-2.md)
- [ЛР 01.3 — Сравнение моделей до/после отбора признаков](./report-01-3.md)
